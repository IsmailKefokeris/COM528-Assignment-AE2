        ...
        <form action="./modifyItem" method="POST">
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Price</td>
                        <td><input type="double" name="price" value="${modifyItem.price}" /></td>
                    </tr>
                </tbody>
            ...
            <button class="btn" type="submit" >Update ${modifyItem.name}</button>
        </form>
        <form action="./catalogue" method="GET">
            <button class="btn" type="submit" >Back To Catalogue</button>
        </form>
